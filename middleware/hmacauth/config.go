...
// HashAlgorithm represents the supported HMAC hash algorithms
...
// Config configures HMAC request signing authentication
type Config struct {
...
// AuditLogger is called for each authentication attempt.
...
type AuditLogger func(accessKeyID string, timestamp time.Time, success bool, errType string)
