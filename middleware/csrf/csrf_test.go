...
func TestCSRF_TokenGeneration(t *testing.T) {
	...
	csrf := New(Config{HMACKey: testHMACKey})(handler)
...
func TestCSRF_TokenWithWrongSignature(t *testing.T) {
	...
	csrf := New(Config{HMACKey: hmacKey})(handler)
	...
	csrf2 := New(Config{HMACKey: hmacKey2})(handler)
...
func TestCSRF_Metrics(t *testing.T) {
	...
	mw := New(Config{HMACKey: testHMACKey})
