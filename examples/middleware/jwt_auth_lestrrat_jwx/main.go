...
func (s *LestrratTokenStore) Validate(ctx context.Context, tokenString string) (config.JWTClaims, error) {
...
func (s *LestrratTokenStore) Generate(ctx context.Context, claims config.JWTClaims, tokenType config.TokenType, ttl time.Duration) (string, error) {
	// Build JWT token
...
func (s *LestrratTokenStore) Revoke(ctx context.Context, claims map[string]any) error {
...
func (s *LestrratTokenStore) IsRevoked(ctx context.Context, claims map[string]any) (bool, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
