...
This example demonstrates zerohttp's JWT authentication middleware using the `github.com/lestrrat-go/jwx` library.

## Features

- Custom TokenStore implementation using lestrrat-go/jwx v3
