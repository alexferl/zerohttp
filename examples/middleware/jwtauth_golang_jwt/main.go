...
func (s *GolangJWTTokenStore) Validate(_ context.Context, tokenString string) (jwtauth.JWTClaims, error) {
...
func (s *GolangJWTTokenStore) Generate(_ context.Context, claims jwtauth.JWTClaims, tokenType jwtauth.TokenType, ttl time.Duration) (string, error) {
...
func loginHandlerGolangJWT(cfg jwtauth.Config) zh.HandlerFunc {
