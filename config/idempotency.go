...
// IdempotencyStore is the interface for idempotency storage backends.
...
// IdempotencyRecord represents a cached idempotent response.
type IdempotencyRecord struct {
	StatusCode int
	// Headers is stored as a flat slice [key1, val1, key2, val2, ...]
...
// DefaultIdempotencyConfig is the default configuration for the idempotency middleware.
